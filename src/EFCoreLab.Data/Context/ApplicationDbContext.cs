        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.HasMany(i => i.Books)
                    ...
                    .HasConstraintName("student_book_id_fk"); //One to Many
            });
            ...
            modelBuilder.Entity<StudentAddress>(entity =>
            {
                ...
                .HasConstraintName("student_address_student_id_fk");// One to One
            });
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                entity.Property(i => i.Id).HasColumnName("id").UseIdentityColumn().ValueGeneratedOnAdd();
                entity.Property(i => i.Author).HasColumnName("author").HasMaxLength(50);
